  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm">
      <div className="bg-white rounded-2xl shadow-lg p-8 max-w-md w-full relative mx-4">
        ...
        <button className="w-full px-6 py-3 bg-blue-400 rounded-full font-semibold text-lg text-white mb-2 opacity-60 cursor-not-allowed" disabled>Upgrade Now</button>
